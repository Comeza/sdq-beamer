...
#let slides(
    ...
    if page > 1 {
      block(
        ...
        stack(
          ...
          dir: ltr,
          (
            text(weight: "bold", size: 24pt)[#context {
                hydra(1)
              }]
          ),
  ...
  let footer_title_page = context {
    ...
    block(
      ...
      align(
        horizon,
        stack(dir: ltr, spacing: 1fr, text(kit-slogan), slogan),
      ),
    )
  }
      ...
      stack(
        box(
          ...
          stack(
            ...
            block(
              height: 2.8cm,
              align(horizon, text(size: 24pt, weight: "bold", series)),
            ),
            block(
              height: 1.4cm,
              align(
        ...
        box(
          ...
          image(height: 7cm, width: 100%, "/logos/banner_2020_kit.jpg"),
        ),
      ),
    ),
  )
